package com.okan.multithreading.demonstrations.threadwait;
...
import com.okan.multithreading.DefaultConfiguration;
...
public class ThreadWaitDemonstrationFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_thread_wait_demonstration, container, false);
